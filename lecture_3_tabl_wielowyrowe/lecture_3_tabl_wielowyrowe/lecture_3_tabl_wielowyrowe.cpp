...
int main()
{
	...
	return 0;
	*/
	// w tej zmiennej zapamiêtamy liczbê wprowadzon¹ przez u¿ytkownika.
	double v;
	cout << "Program pisz_1, demonstrujacy mozliwosci formatowania liczb\n\n" << endl;
	// Poprosimy u¿ytkownika o podanie liczby do wyœwietlenia
	cout << "Wprowadz liczbe do wyswietlenia : ";
	cin >> v;
	// nastêpnie wypiszemy j¹ na ekranie korzystaj¹c ze zmienianej precyzji
	for (int i = 1; i < 9; i++)
